package com.mylatestfree.mylatestfreeevpan.activity;
...
import com.mylatestfree.mylatestfreeevpan.App;
import com.mylatestfree.mylatestfreeevpan.R;
import com.mylatestfree.mylatestfreeevpan.database.DBHelper;
import com.mylatestfree.mylatestfreeevpan.model.Server;
import com.mylatestfree.mylatestfreeevpan.util.CountriesNames;
import com.mylatestfree.mylatestfreeevpan.util.PropertiesService;

import com.mylatestfree.mylatestfreeevpan.util.TotalTraffic;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    protected void getIpInfo(final List<Server> serverList) {
        ...
        for (Server server : serverList) {
            ...
            try {
                jsonObject.put("query", /*server.getIp()*/"103.3.60.211");
                jsonObject.put("lang", /*Locale.getDefault().getLanguage()*/"en");
        ...
        AndroidNetworking.post(getString(R.string.url_check_ip_batch))
                ...
                .getAsJSONArray(new JSONArrayRequestListener() {
                    ...
                    public void onResponse(JSONArray response) {
                        Log.d("jsonArrayRes",response.toString());
